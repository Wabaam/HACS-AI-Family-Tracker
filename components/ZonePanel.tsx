...
// FIX: Aliased History import to avoid conflict with browser's History interface.
import { LogIn, LogOut, History as HistoryIcon, Clock } from 'lucide-react';
      ...
      <div className="flex-grow overflow-y-auto px-4 py-2">
        {events.length > 0 ? (
          ...
          <div className="text-center text-gray-500 mt-10 p-4">
            <HistoryIcon className="w-12 h-12 mx-auto text-gray-600 mb-2" />
