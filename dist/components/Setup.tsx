...
import { HassEntity } from '../types.ts';
import { getAvailablePersonEntities } from '../services/homeAssistantService.ts';
import { Users, CheckCircle, KeyRound } from 'https://esm.sh/lucide-react@0.378.0';

interface SetupProps {
  onComplete: (config: { apiKey: string; selectedEntityIds: string[] }) => void;
}
    ...
    <div className="bg-primary-background-color min-h-screen flex items-center justify-center p-4">
      <div className="w-full max-w-lg">
        <div className="ha-card p-6">
          ...
          <div className="mt-4">
            <label htmlFor="api-key" className="block text-sm font-medium text-primary-text-color mb-2">
              Gemini API Key
            </label>
            <div className="relative">
             ...
             <p className="text-xs text-secondary-text-color mt-2">
                Your key is stored securely in your browser's local storage and never leaves your device.
            </p>
          </div>
